...
<div class="row">
    <div class="col-md-12">
        <form method="post" action="{{ route('cms.achievement_types.achievements.store', ['achievement_type'=>$achievementType->id]) }}">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control form-control-sm" id="points" name="points">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-6">
