...
<div class="row">
    <div class="col-md-12">
        <form method="post" action="{{ route('cms.levels.store') }}">
            @csrf
            ...
            <div class="form-group row">
                <label for="points_needed" class="col-sm-2 col-form-label">Πόντοι που απαιτούνται:</label>
                <div class="col-sm-10">
                    <input type="number" class="form-control form-control-sm" id="points_needed" name="points_needed">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-6">
