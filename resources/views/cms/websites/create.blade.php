...
<div class="row">
    <div class="col-md-12">
        <form method="post" action="{{ route('cms.websites.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control form-control-sm" id="url_pattern" name="url_pattern" value="[value]">
                </div>
            </div>
